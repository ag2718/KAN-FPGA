...
def main():
    ...
    print(f"g++ -I {BASE_DIR}/firmware -I /home/aarushg/KAN-FPGA/HLS_arbitrary_Precision_Types/include -I /home/aarushg/KAN-FPGA/hls-lib-stream {BASE_DIR}/run_kan.cpp")
    ...
    # os.system(f"rm {BASE_DIR}/tb_kan_outputs.dat")
